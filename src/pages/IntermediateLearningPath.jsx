...
const IntermediateLearningPath = () => {
  ...
  const modules = getModuleData('Intermediate').map(module => ({
    ...module,
    icon: TrendingUp,
    color: 'blue'
  }))
                ...
                <div className="bg-gray-50 rounded-lg p-6 mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-blue-600">{lastAttempt.score}/{lastAttempt.totalQuestions}</div>
                      <div className="text-sm text-gray-600">Score</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-purple-600">{lastAttempt.attemptNumber}</div>
          ...
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              ...
              <div className="flex items-center">
                <TrendingUp className="h-8 w-8 text-blue-600 mr-3" />
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Intermediate Learning Path</h1>
                  <p className="text-sm text-gray-600">Master advanced plant and soil concepts</p>
                </div>
              </div>
            </div>
            <div className="text-sm text-gray-600">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {modules.map((module, index) => {
            ...
            const IconComponent = module.icon || TrendingUp
